...
<section class="title">
    ...
    <?php if($_COOKIE["user"]=="rares" || $_COOKIE["user"]=="bianca" || $_COOKIE["user"]=="sergiu"){
	...
	echo "<ul>
		...
		<li>
			<a href=\"http://students.info.uaic.ro/~rares.nechita/weBall/index.php\">Home</a>
		</li>
		
		<li>
			<a href = \"http://students.info.uaic.ro/~rares.nechita/weBall/competitii.php?page=1\">Competitii</a>  
		</li>
			
        <li>
        	<a href = \"http://students.info.uaic.ro/~rares.nechita/weBall/user_competitions.php\">Competitiile mele</a>
        </li>
		 <li><a href = \"http://students.info.uaic.ro/~rares.nechita/weBall/logout.php\">Logout</a>
		</li>
	</ul>";	
	}?>
	</nav>
...
<form>
	...
	<label>Echipa:</label>
        ...
        <label>Jucator:</label>
        <input type = "text" name = "jucator" /><br>
        <label>Minut:</label>
...
<form >
    ...
    <input type = "hidden" name = "echipa2" value = "<?php echo $echipa2;?>"/>
    <br><br>
    <input type="submit" value="Creaza poll" name="c_poll"/><br>
</form>
