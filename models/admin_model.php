...
$GLOBALS['conn']=$db;
	...
	function getAllCompetitions($db){
		...
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
				...
				$output .="<table border=\"1\" style=\"border:#666666 solid 2px;\">";
				$output .="<tr style=\"border:#666666 solid 2px;\"><td>ID</td><td>Nume</td><td>Numar echipe</td><td>Numar echipe calificate</td>";
				$output .="<tr>";
				$output .="<td>".$row['id']."</td>";
	...
	function showGroups($db,$id_comp){
		...
		$output .="<table border=\"1\"><tr><td>Grupa A</td><td>Echipa</td><td>MJ</td><td>V</td><td>E</td><td>I</td><td>G</td><td>pct</td><tr>";
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
				$grupa = $row['grupa'];
				if($grupa!=$group_change){
					$output .="</table></a><br>";	
					$output .= "<a href = \"meciuri_grupa.php?id_comp=".$id_comp."&grupa=".$grupa."\">";
					$output .="<table border=\"1\"><tr><td>Grupa".$row['grupa']."</td><td>Echipa</td><td>MJ</td><td>V</td><td>E</td><td>I</td><td>G</td><td>pct</td><tr>";
					$pos=1;
					$group_change = $grupa;
				}
	...
	function get_optimi($db,$id_comp){
		...
		$res = mysqli_query($db,$query);
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
			$output_optimi .= "<a href = \"actualizeaza_meci.php?id_comp=".$id_comp."&id_meci=".$row['id']."&echipa1=".$row['echipa1']."&echipa2=".$row['echipa2']."\"><table border=\"1\"><tr>";
	...
	function get_sferturi($db,$id_comp){
		...
		$res = mysqli_query($db,$query);
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
			$output_sferturi .= "<a href = \"actualizeaza_meci.php?id_comp=".$id_comp."&id_meci=".$row['id']."&echipa1=".$row['echipa1']."&echipa2=".$row['echipa2']."\"><table border=\"1\"><tr>";
	...
	function get_semifinale($db,$id_comp){
		...
		$res = mysqli_query($db,$query);
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
			$output_semifinale .= "<a href = \"actualizeaza_meci.php?id_comp=".$id_comp."&id_meci=".$row['id']."&echipa1=".$row['echipa1']."&echipa2=".$row['echipa2']."\"><table border=\"1\"><tr>";
	...
	function get_finala($db,$id_comp){
		...
		$res = mysqli_query($db,$query);
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
			$output_finala .= "<a href = \"actualizeaza_meci.php?id_comp=".$id_comp."&id_meci=".$row['id']."&echipa1=".$row['echipa1']."&echipa2=".$row['echipa2']."\"><table border=\"1\"><tr>";
	...
	function getMatchesFromGroup($db,$id_comp,$grupa){
		...
		$res = mysqli_query($db,$query);
		while($row = mysqli_fetch_array($res,MYSQLI_ASSOC)){
			$output .= "<a href = \"actualizeaza_meci.php?id_comp=".$id_comp."&id_meci=".$row['id']."&echipa1=".$row['echipa1']."&echipa2=".$row['echipa2']."\"><table border=\"1\"><tr>";
